...
export ZSH=/Users/LazyRen/.oh-my-zsh
...
alias execl="find . -type f \( -name \"*.out\" -o ! -name \"*.*\" \) -perm +111 -maxdepth 1 -exec rm -i {} \;"

alias fexecl="find . -type f \( -name \"*.out\" -o ! -name \"*.*\" \) -perm +111 -maxdepth 1 -exec rm {} \;"
